...
function calculateTotal(key)
{
  ...
  set_value(key+'shipping_tax_amt',unformat2Number(shippingtax_amt));

  tax += shippingtax_amt;

  set_value(key+'tax_amount',unformat2Number(tax));
  set_value(key+'subtotal_tax_amount',unformat2Number(subtotal) + unformat2Number(tax));
  set_value(key+'total_amount',unformat2Number(subtotal) + tax + unformat2Number(shipping));
}
