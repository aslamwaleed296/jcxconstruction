...
class prchs_Vendors extends Company
{
    public $new_schema = true;
    public $module_dir = 'prchs_Vendors';
    public $object_name = 'prchs_Vendors';
    public $table_name = 'prchs_vendors';
