<?php 
 $GLOBALS["dictionary"]["prchs_Vendors"]=array (
  'table' => 'prchs_vendors',
  'audited' => true,
  'inline_edit' => true,
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'prchs_vendors_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'prchs_vendors_modified_user',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'prchs_vendors_assigned_user',
    ...
    array (
      'name' => 'SecurityGroups',
      'type' => 'link',
      'relationship' => 'securitygroups_prchs_vendors',
    ...
    'prchs_vendors_type' => 
    array (
      'name' => 'prchs_vendors_type',
      'vname' => 'LBL_TYPE',
      'type' => 'enum',
      'options' => 'prchs_vendors_type_dom',
      'len' => 50,
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'prchs_vendors_email_addresses_primary',
      'source' => 'non-db',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'prchs_vendors_email_addresses',
      'module' => 'EmailAddress',
      'source' => 'non-db',
