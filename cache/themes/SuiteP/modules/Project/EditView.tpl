...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_NAME_ACCOUNT' module='Project'}{/capture}
{$label|strip_semicolon}:
...
<input type="text" name="{$fields.account_projects_name.name}" class="sqsEnabled" tabindex="0" id="{$fields.account_projects_name.name}" size="" value="{$fields.account_projects_name.value}" title='' autocomplete="off"  	 >
<input type="hidden" name="{$fields.account_projects_name.id_name}" 
id="{$fields.account_projects_name.id_name}" 
value="{$fields.account_id.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.account_projects_name.name}" id="btn_{$fields.account_projects_name.name}" tabindex="0" title="{sugar_translate label="LBL_ACCESSKEY_SELECT_ACCOUNTS_TITLE"}" class="button firstChild" value="{sugar_translate label="LBL_ACCESSKEY_SELECT_ACCOUNTS_LABEL"}"
onclick='open_popup(
"{$fields.account_projects_name.module}", 
600, 
400, 
"", 
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"account_id","name":"account_projects_name"}}{/literal}, 
"single", 
true
);' ><span class="suitepicon suitepicon-action-select"></span></button><button type="button" name="btn_clr_{$fields.account_projects_name.name}" id="btn_clr_{$fields.account_projects_name.name}" tabindex="0" title="{sugar_translate label="LBL_ACCESSKEY_CLEAR_ACCOUNTS_TITLE"}"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '{$fields.account_projects_name.name}', '{$fields.account_projects_name.id_name}');"  value="{sugar_translate label="LBL_ACCESSKEY_CLEAR_ACCOUNTS_LABEL"}" ><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
<script type="text/javascript">
SUGAR.util.doWhen(
		"typeof(sqs_objects) != 'undefined' && typeof(sqs_objects['{$form_name}_{$fields.account_projects_name.name}']) != 'undefined'",
		enableQS
);
</script>
</div>
...
addToValidate('EditView', 'account_projects_name', 'relate', false,'{/literal}{sugar_translate label='LBL_NAME_ACCOUNT' module='Project' for_js=true}{literal}' );
addToValidate('EditView', 'account_id', 'id', true,'{/literal}{sugar_translate label='LBL_ACCOUNT_ID' module='Project' for_js=true}{literal}' );
