...
{sugar_translate label='LBL_ACCOUNT_INFORMATION' module='prchs_Vendors'}
</div>
</a>
</div>
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_NAME' module='prchs_Vendors'}{/capture}
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_PHONE_OFFICE' module='prchs_Vendors'}{/capture}
{$label|strip_semicolon}:
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_WEBSITE' module='prchs_Vendors'}{/capture}
{$label|strip_semicolon}:
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_FAX' module='prchs_Vendors'}{/capture}
{$label|strip_semicolon}:
...
<div class="col-xs-12 col-sm-6 edit-view-row-item" data-field="ticker_symbol">


<div class="col-xs-12 col-sm-4 label" data-label="LBL_TICKER_SYMBOL">

{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_TICKER_SYMBOL' module='prchs_Vendors'}{/capture}
{$label|strip_semicolon}:
...
<div class="col-xs-12 col-sm-6 edit-view-row-item" data-field="phone_alternate">


<div class="col-xs-12 col-sm-4 label" data-label="LBL_PHONE_ALT">

{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_PHONE_ALT' module='prchs_Vendors'}{/capture}
{$label|strip_semicolon}:
...
<div class="col-xs-12 col-sm-6 edit-view-row-item" data-field="rating">


<div class="col-xs-12 col-sm-4 label" data-label="LBL_RATING">

{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_RATING' module='prchs_Vendors'}{/capture}
{$label|strip_semicolon}:
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_EMPLOYEES' module='prchs_Vendors'}{/capture}
{$label|strip_semicolon}:
...
<div class="col-xs-12 col-sm-6 edit-view-row-item" data-field="ownership">


<div class="col-xs-12 col-sm-4 label" data-label="LBL_OWNERSHIP">

{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_OWNERSHIP' module='prchs_Vendors'}{/capture}
{$label|strip_semicolon}:
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_INDUSTRY' module='prchs_Vendors'}{/capture}
{$label|strip_semicolon}:
...
<div class="col-xs-12 col-sm-6 edit-view-row-item" data-field="prchs_vendors_type">


<div class="col-xs-12 col-sm-4 label" data-label="LBL_TYPE">

{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_TYPE' module='prchs_Vendors'}{/capture}
{$label|strip_semicolon}:

{/minify}
</div>

<div class="col-xs-12 col-sm-8 edit-view-field " type="enum" field="prchs_vendors_type"  >
{counter name="panelFieldCount" print=false}

<select name="{$fields.prchs_vendors_type.name}"
id="{$fields.prchs_vendors_type.name}"
title=''              
>
{if isset($fields.prchs_vendors_type.value) && $fields.prchs_vendors_type.value != ''}
{html_options options=$fields.prchs_vendors_type.options selected=$fields.prchs_vendors_type.value}
{else}
{html_options options=$fields.prchs_vendors_type.options selected=$fields.prchs_vendors_type.default}
{/if}
</select>
</div>
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_ANNUAL_REVENUE' module='prchs_Vendors'}{/capture}
{$label|strip_semicolon}:
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_ASSIGNED_TO_NAME' module='prchs_Vendors'}{/capture}
{$label|strip_semicolon}:
...
<a class="" role="button" data-toggle="collapse-edit" aria-expanded="false">
<div class="col-xs-10 col-sm-11 col-md-11">
{sugar_translate label='LBL_ADDRESS_INFORMATION' module='prchs_Vendors'}
</div>
</a>
</div>
...
<a class="" role="button" data-toggle="collapse-edit" aria-expanded="false">
<div class="col-xs-10 col-sm-11 col-md-11">
{sugar_translate label='LBL_EMAIL_ADDRESSES' module='prchs_Vendors'}
</div>
</a>
</div>
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_EMAIL' module='prchs_Vendors'}{/capture}
{$label|strip_semicolon}:
...
<a class="" role="button" data-toggle="collapse-edit" aria-expanded="false">
<div class="col-xs-10 col-sm-11 col-md-11">
{sugar_translate label='LBL_DESCRIPTION_INFORMATION' module='prchs_Vendors'}
</div>
</a>
</div>
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_DESCRIPTION' module='prchs_Vendors'}{/capture}
{$label|strip_semicolon}:
...
{/literal}{literal}
<script type="text/javascript">
addForm('EditView');addToValidate('EditView', 'name', 'name', true,'{/literal}{sugar_translate label='LBL_NAME' module='prchs_Vendors' for_js=true}{literal}' );
addToValidate('EditView', 'date_entered_date', 'date', false,'Date Created' );
addToValidate('EditView', 'date_modified_date', 'date', false,'Date Modified' );
addToValidate('EditView', 'modified_user_id', 'assigned_user_name', false,'{/literal}{sugar_translate label='LBL_MODIFIED' module='prchs_Vendors' for_js=true}{literal}' );
addToValidate('EditView', 'modified_by_name', 'relate', false,'{/literal}{sugar_translate label='LBL_MODIFIED_NAME' module='prchs_Vendors' for_js=true}{literal}' );
addToValidate('EditView', 'created_by', 'assigned_user_name', false,'{/literal}{sugar_translate label='LBL_CREATED' module='prchs_Vendors' for_js=true}{literal}' );
addToValidate('EditView', 'created_by_name', 'relate', false,'{/literal}{sugar_translate label='LBL_CREATED' module='prchs_Vendors' for_js=true}{literal}' );
addToValidate('EditView', 'description', 'text', false,'{/literal}{sugar_translate label='LBL_DESCRIPTION' module='prchs_Vendors' for_js=true}{literal}' );
addToValidate('EditView', 'deleted', 'bool', false,'{/literal}{sugar_translate label='LBL_DELETED' module='prchs_Vendors' for_js=true}{literal}' );
addToValidate('EditView', 'assigned_user_id', 'relate', false,'{/literal}{sugar_translate label='LBL_ASSIGNED_TO_ID' module='prchs_Vendors' for_js=true}{literal}' );
addToValidate('EditView', 'assigned_user_name', 'relate', false,'{/literal}{sugar_translate label='LBL_ASSIGNED_TO_NAME' module='prchs_Vendors' for_js=true}{literal}' );
addToValidate('EditView', 'prchs_vendors_type', 'enum', false,'{/literal}{sugar_translate label='LBL_TYPE' module='prchs_Vendors' for_js=true}{literal}' );
addToValidate('EditView', 'industry', 'enum', false,'{/literal}{sugar_translate label='LBL_INDUSTRY' module='prchs_Vendors' for_js=true}{literal}' );
addToValidate('EditView', 'annual_revenue', 'varchar', false,'{/literal}{sugar_translate label='LBL_ANNUAL_REVENUE' module='prchs_Vendors' for_js=true}{literal}' );
addToValidate('EditView', 'phone_fax', 'phone', false,'{/literal}{sugar_translate label='LBL_FAX' module='prchs_Vendors' for_js=true}{literal}' );
addToValidate('EditView', 'billing_address_street', 'varchar', false,'{/literal}{sugar_translate label='LBL_BILLING_ADDRESS_STREET' module='prchs_Vendors' for_js=true}{literal}' );
addToValidate('EditView', 'billing_address_street_2', 'varchar', false,'{/literal}{sugar_translate label='LBL_BILLING_ADDRESS_STREET_2' module='prchs_Vendors' for_js=true}{literal}' );
addToValidate('EditView', 'billing_address_street_3', 'varchar', false,'{/literal}{sugar_translate label='LBL_BILLING_ADDRESS_STREET_3' module='prchs_Vendors' for_js=true}{literal}' );
addToValidate('EditView', 'billing_address_street_4', 'varchar', false,'{/literal}{sugar_translate label='LBL_BILLING_ADDRESS_STREET_4' module='prchs_Vendors' for_js=true}{literal}' );
addToValidate('EditView', 'billing_address_city', 'varchar', false,'{/literal}{sugar_translate label='LBL_BILLING_ADDRESS_CITY' module='prchs_Vendors' for_js=true}{literal}' );
addToValidate('EditView', 'billing_address_state', 'varchar', false,'{/literal}{sugar_translate label='LBL_BILLING_ADDRESS_STATE' module='prchs_Vendors' for_js=true}{literal}' );
addToValidate('EditView', 'billing_address_postalcode', 'varchar', false,'{/literal}{sugar_translate label='LBL_BILLING_ADDRESS_POSTALCODE' module='prchs_Vendors' for_js=true}{literal}' );
addToValidate('EditView', 'billing_address_country', 'varchar', false,'{/literal}{sugar_translate label='LBL_BILLING_ADDRESS_COUNTRY' module='prchs_Vendors' for_js=true}{literal}' );
addToValidate('EditView', 'rating', 'varchar', false,'{/literal}{sugar_translate label='LBL_RATING' module='prchs_Vendors' for_js=true}{literal}' );
addToValidate('EditView', 'phone_office', 'phone', false,'{/literal}{sugar_translate label='LBL_PHONE_OFFICE' module='prchs_Vendors' for_js=true}{literal}' );
addToValidate('EditView', 'phone_alternate', 'phone', false,'{/literal}{sugar_translate label='LBL_PHONE_ALT' module='prchs_Vendors' for_js=true}{literal}' );
addToValidate('EditView', 'website', 'url', false,'{/literal}{sugar_translate label='LBL_WEBSITE' module='prchs_Vendors' for_js=true}{literal}' );
addToValidate('EditView', 'ownership', 'varchar', false,'{/literal}{sugar_translate label='LBL_OWNERSHIP' module='prchs_Vendors' for_js=true}{literal}' );
addToValidate('EditView', 'employees', 'varchar', false,'{/literal}{sugar_translate label='LBL_EMPLOYEES' module='prchs_Vendors' for_js=true}{literal}' );
addToValidate('EditView', 'ticker_symbol', 'varchar', false,'{/literal}{sugar_translate label='LBL_TICKER_SYMBOL' module='prchs_Vendors' for_js=true}{literal}' );
addToValidate('EditView', 'shipping_address_street', 'varchar', false,'{/literal}{sugar_translate label='LBL_SHIPPING_ADDRESS_STREET' module='prchs_Vendors' for_js=true}{literal}' );
addToValidate('EditView', 'shipping_address_street_2', 'varchar', false,'{/literal}{sugar_translate label='LBL_SHIPPING_ADDRESS_STREET_2' module='prchs_Vendors' for_js=true}{literal}' );
addToValidate('EditView', 'shipping_address_street_3', 'varchar', false,'{/literal}{sugar_translate label='LBL_SHIPPING_ADDRESS_STREET_3' module='prchs_Vendors' for_js=true}{literal}' );
addToValidate('EditView', 'shipping_address_street_4', 'varchar', false,'{/literal}{sugar_translate label='LBL_SHIPPING_ADDRESS_STREET_4' module='prchs_Vendors' for_js=true}{literal}' );
addToValidate('EditView', 'shipping_address_city', 'varchar', false,'{/literal}{sugar_translate label='LBL_SHIPPING_ADDRESS_CITY' module='prchs_Vendors' for_js=true}{literal}' );
addToValidate('EditView', 'shipping_address_state', 'varchar', false,'{/literal}{sugar_translate label='LBL_SHIPPING_ADDRESS_STATE' module='prchs_Vendors' for_js=true}{literal}' );
addToValidate('EditView', 'shipping_address_postalcode', 'varchar', false,'{/literal}{sugar_translate label='LBL_SHIPPING_ADDRESS_POSTALCODE' module='prchs_Vendors' for_js=true}{literal}' );
addToValidate('EditView', 'shipping_address_country', 'varchar', false,'{/literal}{sugar_translate label='LBL_SHIPPING_ADDRESS_COUNTRY' module='prchs_Vendors' for_js=true}{literal}' );
addToValidate('EditView', 'email1', 'varchar', false,'{/literal}{sugar_translate label='LBL_EMAIL' module='prchs_Vendors' for_js=true}{literal}' );
addToValidate('EditView', 'email_addresses_non_primary', 'email', false,'{/literal}{sugar_translate label='LBL_EMAIL_NON_PRIMARY' module='prchs_Vendors' for_js=true}{literal}' );
addToValidateBinaryDependency('EditView', 'assigned_user_name', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='prchs_Vendors' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_ASSIGNED_TO' module='prchs_Vendors' for_js=true}{literal}', 'assigned_user_id' );
