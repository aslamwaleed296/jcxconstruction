...
$dictionary['jcx_purchase_orders'] = array(
    'table' => 'jcx_purchase_orders',
    'audited' => true,
    'inline_edit' => true,
    ...
    'fields' => array (
        ...
        'aos_products_quotes' =>
            array(
                ...
                'type' => 'link',
                'relationship' => 'jcx_purchase_orders_aos_product_quotes',
        ...
        'aos_line_item_groups' =>
            array(
                ...
                'type' => 'link',
                'relationship' => 'jcx_purchase_orders_aos_line_item_groups',
    ...
    'relationships' => array(
        'jcx_purchase_orders_aos_product_quotes' =>
            array(
                'lhs_module' => 'jcx_purchase_orders',
                'lhs_table' => 'jcx_purchase_orders',
                'lhs_key' => 'id',
        ...
        'jcx_purchase_orders_aos_line_item_groups' =>
            array(
                'lhs_module' => 'jcx_purchase_orders',
                'lhs_table' => 'jcx_purchase_orders',
                'lhs_key' => 'id',
...
VardefManager::createVardef('jcx_purchase_orders', 'jcx_purchase_orders', array('basic','assignable','security_groups'));